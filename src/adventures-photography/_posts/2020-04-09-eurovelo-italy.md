...
{% figure %}
  {% img src: 20160622-DSCF8172, alt: Decending into the flatlands. %}
...
{% figure %}
  {% img src: 20160622-DSCF8187, alt: Decending into the flatlands. %}
...
{% figure %}
  {% img src: 20160623-DSCF8207, alt: The bikes on the seafront in Dubrovnik. %}

  <div class="row pair">
    {% img src: 20160623-DSCF8200, alt: The streets of Dubrovnik. %}
    {% img src: 20160623-DSCF8202, alt: The streets of Dubrovnik. %}
  </div>
...
{% figure %}
  ...
  <div class="row pair">
    {% img src: 20160623-DSCF8205, alt: The streets of Dubrovnik. %}
    {% img src: 20160623-DSCF8204, alt: The streets of Dubrovnik. %}
  </div>
...
{% figure %}
  <div class="row pair">
    {% img src: 20160623-DSCF8242, alt: The streets of Dubrovnik. %}
    {% img src: 20160623-DSCF8243, alt: The streets of Dubrovnik. %}
  </div>

  <div class="row pair">
    {% img src: 20160624-DSCF8247, alt: The streets of Dubrovnik. %}
    {% img src: 20160624-DSCF8248, alt: The streets of Dubrovnik. %}
  </div>
...
{% figure %}
  {% img src: 20160624-DSCF8288, alt: Decending into the flatlands. %}

  {% figcaption %}Decending into the flatlands.{% endfigcaption %}
{% endfigure %}

{% figure narrow %}
  {% img src: 20160624-DSCF8286, alt: Decending into the flatlands. %}
...
{% figure %}
  <div class="row pair">
    {% img src: 20160625-DSCF8293, alt: The streets of Dubrovnik. %}
    {% img src: 20160625-DSCF8295, alt: The streets of Dubrovnik. %}
  </div>

  {% img src: 20160625-DSCF8297, alt: The bikes on the seafront in Dubrovnik. %}

  <div class="row pair">
    {% img src: 20160625-DSCF8298, alt: The streets of Dubrovnik. %}
    {% img src: 20160625-DSCF8299, alt: The streets of Dubrovnik. %}
  </div>
...
{% figure narrow %}
  ...
  <div class="row pair">
    {% img src: 20160625-DSCF8319, alt: The streets of Dubrovnik. %}
    {% img src: 20160625-DSCF8320, alt: The streets of Dubrovnik. %}
  </div>
...
{% figure narrow %}
  ...
  <div class="row pair">
    {% img src: 20160625-DSCF8346, alt: The streets of Dubrovnik. %}
    {% img src: 20160625-DSCF8355, alt: The streets of Dubrovnik. %}
  </div>
...
{% figure narrow %}
  {% img src: 20160625-DSCF8359, alt: Decending into the flatlands. %}
...
{% figure narrow %}
  ...
  <div class="row pair">
    {% img src: 20160626-DSCF8367, alt: The streets of Dubrovnik. %}
    {% img src: 20160626-DSCF8369, alt: The streets of Dubrovnik. %}
  </div>
