...
{% figure %}
  {% img src: /assets/adventures_photography/2016-01-31-group/20160130-DSCF5612.jpg, alt: Sunrise over Sharpitor %}
...
{% figure %}
  {% img src: /assets/adventures_photography/2016-01-31-group/20160130-DSCF5623.jpg, alt: Sunrise over Sharpitor %}
  {% figcaption %}Sunrise over Sharpitor. {% endfigcaption %}
{% endfigure %}
...
{% figure %}
  {% img src: /assets/adventures_photography/2016-01-31-group/20160130-DSCF5635.jpg, alt: Sunrise over Sharpitor %}
  {% figcaption %}Sunrise over Sharpitor. {% endfigcaption %}
{% endfigure %}
...
{% figure %}
  {% img src: /assets/adventures_photography/2016-01-31-group/20160130-DSCF5630.jpg, alt: Sunrise over Sharpitor %}
  {% figcaption %}Sunrise over Sharpitor. {% endfigcaption %}
{% endfigure %}
