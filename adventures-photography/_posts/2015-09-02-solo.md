...
thumb: /camera-roll/2015/09/solo/thumb.jpg

banner: /camera-roll/2015/09/solo/header.jpg
...
{% figure %}
  {% img src: /assets/camera-roll/2015/09/solo/20150829-DSC_0382-HDR.jpg, alt: Looking back towards Okehampton around two hours into the first day. %}
...
{% figure %}
  {% img src: /assets/camera-roll/2015/09/solo/20150829-DSC_0395-HDR.jpg, alt: Ford Crossing on the River Taw %}
...
{% figure %}
  {% img src: /assets/camera-roll/2015/09/solo/20150829-DSC_0498-Edit.jpg, alt: An incredible sunset over the waterfalls of the East Dart River at the end of the first day %}
