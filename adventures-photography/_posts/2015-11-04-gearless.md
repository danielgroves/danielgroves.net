...
thumb: 2015-10-web-DSC_1746-2.jpg

banner: 2015-10-web-DSC_1746.jpg
...
{% figure row_2 %}
  {% img src: 2015-10-web-DSC_1232.jpg, alt: Bikes on NCN27 cycle route. %}
  {% img src: 2015-10-web-DSC_1237.jpg, alt: Bike above Burrator. %}
{% endfigure %}
...
{% figure %}
  {% img src: 2015-10-web-DSC_1365-HDR-Edit.jpg, alt: Some amazing light shafts formed at sunset. This shot is looking towards Tavistock from the top of Great Mis Tor. %}
...
{% figure %}
  {% img src: 2015-10-web-DSC_1746.jpg, alt: Both of the tents pitched during the night. Mine is lit while I was lying inside reading during the evening. %}
...
{% figure %}
  {% img src: 2015-10-web-DSC_1832-HDR.jpg, alt: Sunrise, looking west from Great Mis Tor %}

  <div class="row pair">
    {% img src: 2015-10-web-DSC_1802-Edit.jpg, alt: Sunrise, looking west from Great Mis Tor %}
    {% img src: 2015-10-web-DSC_1857-Edit.jpg, alt: Sunrise, looking west from Great Mis Tor %}
  </div>
{% endfigure %}
...
{% figure row_2 %}
  {% img src: 2015-10-web-DSC_1953.jpg, alt: Luke, just before the halfway point on Widowmaker. %}
  {% img src: 2015-10-web-DSC_1961.jpg, alt: Luke on the last couple of meters of the Widowmaker before it rejoins the road around Burrator. %}
{% endfigure %}
