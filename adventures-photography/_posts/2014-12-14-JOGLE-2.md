...
thumb: 2014-08-web-DSC_1358.jpg
banner: 2014-08-web-DSC_1358.jpg
...
{% figure %}
  {% img src: 2014-07-web-DSC_1141.jpg, alt: Sunset coming into Oban. %}
...
{% figure %}
  {% img src: 2014-07-web-DSC_1172.jpg, alt: A smaller Loch, just outside Dunoon. %}
...
{% figure %}
  {% img src: 2014-07-web-DSC_1181.jpg, alt: Incoming Rain. %}
...
{% figure %}
  {% img src: 2014-07-web-DSC_1182.jpg, alt: Goodbye Scotalnd; Hello England. %}
...
{% figure %}
  {% img src: 2014-07-web-DSC_1187.jpg, alt: Up, up, and more up. It's the Kirkstone Pass. %}
...
{% figure %}
  {% img src: 2014-07-web-DSC_1283.jpg, alt: Possibly one of my all-time favourite wild-camping spots. The view is almost endless. %}
...
{% figure %}
  {% img src: 2014-07-web-DSC_1319.jpg, alt: The steadily improving canal network paths into Leeds. %}
...
{% figure %}
  {% img src: 2014-07-web-DSC_1322.jpg, alt: We're going to get wet, again. %}
...
{% figure %}
  {% img src: 2014-08-web-DSC_1324.jpg, alt: The somerset levels, with Glastonbury Tor sat in the middle. %}
...
{% figure %}
  {% img src: 2014-08-web-DSC_1351.jpg, alt: Looking over Dartmoor. %}
...
{% figure %}
  {% img src: 2014-08-web-DSC_1358.jpg, alt: We made it! The bikes at Lands End. %}
...
{% figure %}
  {% img src: 2014-08-web-DSC_1367.jpg, alt: The horrible but required end-shot. %}
