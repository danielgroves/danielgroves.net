...
{% figure row_2 %}
  ...
  {% figcaption %}
    **Left:** Glen Etive, Scotland. Shot using two ND1000 filters on a Sigma 10-20 ƒ/3.5 on a Nikon D7100 body. <br />
    **Right:** St. Micheals Chapel, Rame Head, Cornwall. Shot using a single ND1000 filter on a Sigma 10-20 ƒ/3.5 on a Nikon D7100 body.
  {% endfigcaption %}
{% endfigure %}
...
{% figure %}
  {% img src: /assets/notebook/2016-02-gear/20160127-DSCF5524.jpg, alt: Cokin filters piled up on my desk. %}
  {% figcaption %}Cokin filters piled up on my desk.{% endfigcaption %}
{% endfigure %}
