...
thumb: 2016-01-web-DSCF5518-2.jpg
banner: 2016-01-web-DSCF5518.jpg
---
...
{% figure %}
  {% img src: 2016-01-web-DSCF5518.jpg, alt: Samyang 12mm ƒ/2. This picture really shows how well the X-T1 and 18-55 lens work together. %}
...
{% figure %}
  {% img src: 2016-01-web-DSCF5492.jpg, alt: Plymouth Hoe at dusk. Shot with Samyang 12mm ƒ/2 on a Fuji XT-1 using a Cokin P.154 and a P.121M. %}

  <div class="row pair">
    {% img src: 2015-08-web-DSC_9026-Edit-2.jpg, alt: Glen Etive, Scotland. Shot using two ND1000 filters on a Sigma 10-20 ƒ/3.5 on a Nikon D7100 body. %}
    {% img src: 2015-11-web-DSC_2031.jpg, alt: St. Micheals Chapel, Rame Head, Cornwall. Shot using a single ND1000 filter on a Sigma 10-20 ƒ/3.5 on a Nikon D7100 body. %}
  </div>
...
{% figure %}
  {% img src: 2016-02-web-DSC_2653.jpg, alt: Cokin filter system in use with the Samyang 12mm ƒ/2 and Fuji XT-1. %}
...
{% figure %}
  {% img src: 2016-01-web-DSCF5521.jpg, alt: The tiny Fuji EF-X8 flash next to the Fuji 18-55 ƒ/2.8-4 XF Zoom lens. %}
...
{% figure %}
  {% img src: 2016-01-web-DSCF5531.jpg, alt: The Gepe Card Safe Extreme with a small pile of SanDisk Extreme and Extreme Pro SD Cards. %}
